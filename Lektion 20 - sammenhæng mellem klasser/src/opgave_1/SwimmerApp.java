...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                s1.getName() + " træner " + s1.getTrainingHours() + " timer om ugen i følge hans træningsplan.");
        System.out.println(
                s2.getName() + " træner " + s2.getTrainingHours() + " timer om ugen i følge hans træningsplan.");
        System.out.println(
                s3.getName() + " træner " + s3.getTrainingHours() + " timer om ugen i følge hans træningsplan.");
        //
        // System.out.println("Svømmerne træner totalt "
